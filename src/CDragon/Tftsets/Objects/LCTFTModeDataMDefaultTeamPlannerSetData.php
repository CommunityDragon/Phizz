 ...
 * @property-read LCTFTModeDataMDefaultTeamPlannerSetSetTeamPlannerDataData $setTeamPlannerData
 */
class LCTFTModeDataMDefaultTeamPlannerSetData extends StaticData
{
    protected array $objects = [
        'set_team_planner_data' => LCTFTModeDataMDefaultTeamPlannerSetSetTeamPlannerDataData::class,
    ];
}
