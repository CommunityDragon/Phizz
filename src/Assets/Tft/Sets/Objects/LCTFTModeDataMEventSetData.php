 ...
 * @property-read LCTFTModeDataMEventSetSetTeamPlannerDataData $setTeamPlannerData
 */
class LCTFTModeDataMEventSetData extends StaticData
{
    protected array $objects = [
        'set_team_planner_data' => LCTFTModeDataMEventSetSetTeamPlannerDataData::class,
    ];
}
